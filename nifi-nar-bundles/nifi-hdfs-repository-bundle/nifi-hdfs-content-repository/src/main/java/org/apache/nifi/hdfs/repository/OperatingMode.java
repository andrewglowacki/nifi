...
public enum OperatingMode {
     ...
     * containers written to until a configured time period has elapsed write failures.
     *
     ...
     * As files are moved to the archive, they are copied and then deleted to the containers in the 'archive' group.
     *
